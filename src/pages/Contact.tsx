...
export default function Contact() {
  ...
  return (
    <>
      <Helmet>
        <title>Contact | Interieur-Idee</title>
        <meta name="description" content="Neem contact op met Interieur-Idee voor een vrijblijvend gesprek over interieurarchitectuur, ontwerp en advies in Delft en omgeving." />
        <meta property="og:title" content="Contact | Interieur-Idee" />
        <meta property="og:description" content="Contactgegevens van Interieur-Idee. Plan een vrijblijvend gesprek over interieuradvies en ontwerp." />
