...
export default function Aanpak() {
  ...
  return (
    <>
      <Helmet>
        <title>Onze Aanpak | Interieur-Idee</title>
        <meta name="description" content="Lees hoe Interieur-Idee te werk gaat: van intake tot ontwerp en realisatie. Persoonlijke begeleiding en creatieve oplossingen voor elk interieur." />
        <meta property="og:title" content="Onze Aanpak | Interieur-Idee" />
        <meta property="og:description" content="Ontdek de werkwijze van Interieur-Idee: van intake tot realisatie, met oog voor detail en persoonlijke wensen." />
...
<div 
  className="h-[300px] md:h-[500px] bg-contain bg-center bg-no-repeat" 
  style={{ backgroundImage: "url('/lovable-uploads/aanpakinterieur.webp')" }}
  role="img"
  aria-label="Interieur aanpak illustratie"
></div>
              </div>
            </div>
          </div>
